...
{% hint style="info" %}
**Liskov almashtirish printsipi (Liskov Substitution Principle)** - __ yuqori sinf obyektlari dasturni buzmasdan uning kichik sinflari obyektlari bilan almashtirilishi kerak. Bu sizning pastki sinflaringiz obyektlari sizning yuqori sinfingiz obyektlari kabi harakat qilishini talab qiladi. __
{% endhint %}
