...
**GetString()** – **GetBytes()** ga teskari ishni bajaradi. Ya’ni **GetBytes()** *string*dan *byte[]* ga o’girgan bo’lsa, **GetString()** o’ziga berilgan *byte* tipidagi massivga ko’ra ko’rsatilgan kodlash turida satrni qaytaradi.
```csharp
using System;
using System.Text;
namespace ConsoleApp3
