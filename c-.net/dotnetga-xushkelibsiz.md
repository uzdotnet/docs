...
![Vipolnit](<../.gitbook/assets/image (64).png>)
...
![Anaa dotnet ni tanigani uchun shu narsalar chiqdi](<../.gitbook/assets/image (11).png>)
...
__Yoki dotnet SDK install bo'lmagan bo'ladi, yoki CMD ni avvalroq ochib olgansiz (SDK install bolishidan avval). Muammoni hal qlish uchun CMD ni qayta ishga tushirib yuborish talab etiladi.
{% endhint %}
